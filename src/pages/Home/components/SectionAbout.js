...
const SectionAbout = () => {
  ...
  const animatedText = {
    career0: useScrollFadeIn('up', 1, 0.1, '5rem'),
    career1: useScrollFadeIn('right', 1, 0.1, '5rem'),
    career2: useScrollFadeIn('down', 1, 0.1, '5rem'),
    career3: useScrollFadeIn('left', 1, 0.1, '5rem'),
    career4: useScrollFadeIn('up', 1, 0.1, '5rem'),
    career5: useScrollFadeIn('right', 1, 0.1, '5rem'),
    career6: useScrollFadeIn('down', 1, 0.1, '5rem'),
    career7: useScrollFadeIn('left', 1, 0.1, '5rem'),
    career8: useScrollFadeIn('up', 1, 0.1, '5rem'),
  };
