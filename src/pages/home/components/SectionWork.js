...
const works = [
  {
    ...
    imgs: [process.env.PUBLIC_URL + `img/p09-01.png`, process.env.PUBLIC_URL + `img/p09-02.png`, process.env.PUBLIC_URL + `img/p09-03.png`, process.env.PUBLIC_URL + `img/p09-04.png`],
  },
  {
    id: 9,
    type: 'Responsive Web',
    ...
    imgs: [process.env.PUBLIC_URL + `img/p08-03.png`, process.env.PUBLIC_URL + `img/p08-02.png`, process.env.PUBLIC_URL + `img/p08-04.png`, process.env.PUBLIC_URL + `img/p08-05.png`],
  },
  {
    id: 8,
    type: 'Responsive Web',
    ...
    imgs: [process.env.PUBLIC_URL + `img/p07-01.webp`, process.env.PUBLIC_URL + `img/p07-02.webp`, process.env.PUBLIC_URL + `img/p07-03.webp`, process.env.PUBLIC_URL + `img/p07-04.webp`],
  },
  {
    id: 7,
    type: 'Responsive Web',
  ...
  },
  {
    ...
    imgs: [process.env.PUBLIC_URL + `img/p05-01.png`, process.env.PUBLIC_URL + `img/p05-02.png`, process.env.PUBLIC_URL + `img/p05-03.png`, process.env.PUBLIC_URL + `img/p05-04.png`],
  },
  {
    id: 5,
    type: 'PC · Mobile Web',
